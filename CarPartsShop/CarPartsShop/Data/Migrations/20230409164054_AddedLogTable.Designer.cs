...
namespace CarPartsShop.Data.Migrations
{
    ...
    [Migration("20230409164054_AddedLogTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarPartsShop.Data.Models.log_19118067", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<DateTime>("OperationCreateTime")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("log_19118067", "19118067");
                });
            ...
            modelBuilder.Entity("CarPartsShop.Data.Models.PickedUpPart", b =>
                {
                    ...
                    b.HasOne("CarPartsShop.Data.Models.Order", null)
                        .WithMany("Parts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CarPartsShop.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
